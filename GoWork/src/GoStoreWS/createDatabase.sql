...
alter table magasin owner to poe;
alter table rayon owner to poe;
alter table produit owner to poe;
alter table panier owner to poe;
alter table panier_item owner to poe;
